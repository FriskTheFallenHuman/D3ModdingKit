...
struct gameVersion_s {
	gameVersion_s( void ) { sprintf( string, "%s.%d%s %s-%s %s %s", BUILD_ENGINE_VERSION, BUILD_NUMBER, BUILD_TYPE, BUILD_OS, D3_ARCH, ID__DATE__, ID__TIME__ ); }
	char	string[256];
} gameVersion;
...
// server info
idCVar si_name(						"si_name",					"My Game Server",	CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE, "name of the server" );
