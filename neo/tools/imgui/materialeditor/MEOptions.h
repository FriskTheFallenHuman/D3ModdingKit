...
public:
	...
	*/
	...
	void				SetWindowPlacement		( const char* name, int hwnd );
	bool				GetWindowPlacement		( const char* name, int hwnd );
...
ID_INLINE void MEOptions::SetWindowPlacement ( const char* name, int hwnd ) {
	//registry.SetWindowPlacement ( name, hwnd );
}

ID_INLINE bool MEOptions::GetWindowPlacement ( const char* name, int hwnd ) {
	return false; //registry.GetWindowPlacement ( name, hwnd );
}
