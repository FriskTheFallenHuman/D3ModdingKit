...
//#modified-fva; BEGIN
idCVar cst_hudAdjustAspect("cst_hudAdjustAspect", "1", CVAR_GUI | CVAR_BOOL | CVAR_ARCHIVE | CVAR_NEW, "adjust the HUD's aspect when the screen aspect ratio isn't 4:3");
//#modified-fva; END
